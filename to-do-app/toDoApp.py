...
# icon
Image_icon = PhotoImage(file="to-do-app/images/task.png")
root.iconphoto(False, Image_icon)

# top bar
TopImage = PhotoImage(file="to-do-app/images/topbar.png")
Label(root, image=TopImage).pack()

dockImage = PhotoImage(file="to-do-app/images/dock.png")
Label(root, image=dockImage, bg="#32405b").place(x=30, y=25)

noteImage = PhotoImage(file="to-do-app/images/task.png")
...
Delete_icon = PhotoImage(file="to-do-app/images/delete.png")
