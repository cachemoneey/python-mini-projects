...
# icon
image_icon = PhotoImage(file="python-idle/logo.png")
...
Open = PhotoImage(file="python-idle/open.png")
Save = PhotoImage(file="python-idle/save.png")
Run = PhotoImage(file="python-idle/run.png")
