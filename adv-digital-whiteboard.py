...
root = Tk()
root.title("Advanced Digital Whiteboard")
...
def insertimage():
    ...
    my_img = canvas.create_image(100,50, image=f_img)
...
eraser = PhotoImage(file="advanced-digital-whiteboard/red-candy.png")
Button(root, image=eraser, bg="#f2f3f5", command=new_canvas).place(x=30,y=400)

importimage = PhotoImage(file="advanced-digital-whiteboard/open.png")
